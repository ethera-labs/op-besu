...
import org.hyperledger.besu.ethereum.api.jsonrpc.internal.methods.DebugCodeByHash;
import org.hyperledger.besu.ethereum.api.jsonrpc.internal.methods.DebugDbGet;
...
public class DebugJsonRpcMethods extends ApiGroupJsonRpcMethods {
  ...
  protected Map<String, JsonRpcMethod> create() {
    ...
    return mapOf(
        ...
        new DebugCodeByHash(protocolContext.getWorldStateArchive()),
        new DebugDbGet(protocolContext.getWorldStateArchive()),
        new DebugTraceCall(
            blockchainQueries,
            protocolSchedule,
