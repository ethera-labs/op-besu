...
import static org.hyperledger.besu.evm.precompile.MainnetPrecompiledContracts.populateForIsthmus;
...
public interface MainnetPrecompiledContractRegistries {
  ...
  static PrecompileContractRegistry isthmus(
      final PrecompiledContractConfiguration precompiledContractConfiguration) {
    final PrecompileContractRegistry registry = new PrecompileContractRegistry();
    populateForIsthmus(registry, precompiledContractConfiguration.getGasCalculator());
    return registry;
  }
